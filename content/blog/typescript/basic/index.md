...
### 11.2 타입 가드에 사용되는 연산자: instanceof
...
### 11.6 구별된 유니언(Discriminated unions)
...
### 12.1 구조적 타이핑(structural typing)
...
### 13.1 타입스크립트 모듈화 문법: import type
